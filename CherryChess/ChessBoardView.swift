        ...
        GeometryReader { geometry in
            ...
            ZStack(alignment: .topLeading) {
                ...
                if let arrow = bestMoveArrow {
                    BestMoveArrowView(start: arrow.start, end: arrow.end, squareSize: squareSize, isFlipped: viewModel.boardFlipped)
            }
        }
...
/// Draws a move arrow (straight or L-shaped for knight moves) in board screen coordinates.
struct BestMoveArrowView: View {
    let start: Square
    let end: Square
